...
|------------------------------|---------------|
| ParticleNetworkBase          | 0.14.2         |
| ParticleAuthService          | 0.14.2         |
| ParticleWalletAPI            | 0.14.2         |
| ParticleWalletGUI            | 0.14.2         |
| ParticleWalletConnect        | 0.14.2         | 
| ParticleBiconomy             | 0.14.2         | 
