...
|------------------------------|---------------|
| ParticleNetworkBase          | 0.14.3         |
| ParticleAuthService          | 0.14.3         |
| ParticleWalletAPI            | 0.14.3         |
| ParticleWalletGUI            | 0.14.3         |
| ParticleWalletConnect        | 0.14.3         | 
| ParticleBiconomy             | 0.14.3         | 
