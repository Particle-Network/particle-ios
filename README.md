...
|------------------------------|---------------|
| ParticleNetworkBase          | 0.13.1         |
| ParticleAuthService          | 0.13.1         |
| ParticleWalletAPI            | 0.13.1         |
| ParticleWalletGUI            | 0.13.1         |
| ParticleWalletConnect        | 0.13.1         | 
| ParticleBiconomy             | 0.13.1         | 
