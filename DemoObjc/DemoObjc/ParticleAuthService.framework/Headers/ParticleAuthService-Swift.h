...
/// Login
/// \param type Login type, email or phone
///
/// \param successHandler Success handler, user info.
///
/// \param failureHandler Failure handler.
///
+ (void)loginWithType:(enum LoginType)type successHandler:(void (^ _Nonnull)(UserInfo * _Nonnull))successHandler failureHandler:(void (^ _Nonnull)(NSError * _Nonnull))failureHandler;
/// Logout
...
/// Sign transaction
/// \param message Transaction that you want the user to sign.
///
/// \param successHandler Success handler, signed message.
///
/// \param failureHandler Failure handler.
///
+ (void)signTransaction:(NSString * _Nonnull)message successHandler:(void (^ _Nonnull)(NSString * _Nonnull))successHandler failureHandler:(void (^ _Nonnull)(NSError * _Nonnull))failureHandler;
...
@interface ParticleAuthService (SWIFT_EXTENSION(ParticleAuthService))
@end


SWIFT_CLASS("_TtCC19ParticleAuthService19ParticleAuthService13Notifications")
...
- (nonnull instancetype)initWithPublicKey:(NSString * _Nonnull)publicKey address:(NSString * _Nonnull)address token:(NSString * _Nonnull)token uuid:(NSString * _Nonnull)uuid OBJC_DESIGNATED_INITIALIZER;
