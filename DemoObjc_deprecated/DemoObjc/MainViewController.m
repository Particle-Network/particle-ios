...
- (void)login:(LoginType)type {
    ...
    [ParticleAuthService loginWithType:type account:nil supportAuthType:supportAuthTypes socialLoginPrompt: SocialLoginPromptNull authorization: nil successHandler:^(UserInfo * userInfo) {
        NSLog(@"%@", userInfo);
        [self showLogin:NO];
